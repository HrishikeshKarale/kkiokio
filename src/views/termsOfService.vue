...
<template>
  ...
  <p>
    ...
    <span class="website_url">www.kkiokio.com</span> website and various related
    services (collectively, the "Website") to you, the User, subject to your
  ...
  <p>
    ...
    these Terms of Service. All such guidelines or rules are hereby incorporated
    by reference into these Terms of Service.
  </p>

  <p>
    These Terms of Service are effective as of <span class="date">[DATE]</span>.
    We expressly reserve the right to change these Terms of Service from time to
  ...
  <p>
    ...
    acknowledgement of the modified Terms of Service and agreement to abide and
    be bound by the modified Terms of Service.
  </p>

  <p>
    We reserve the sole right to either modify or discontinue the Website,
    including any of the Website’s features, at any time with or without notice
    to you. We will not be liable to you or any third party should we exercise
    such right. Any new features that augment or enhance the then-current
    services on this Website shall also be subject to these Terms of Service.
    This Terms of Service was created by
    <a href="https://www.termsservicetemplate.com">Terms Service Template</a>
    and the
  ...
  <p>
    ...
    through this Website, you agree that you will not upload, share, post, or
  ...
  <p>
    ...
    uploaded or submitted by third party users of the Website. We generally do
    ...
    libraries, or other interactive services that may be available on or through
    this Website. However, we and our agents have the right at their sole
    discretion to remove any content that, in our judgment, does not comply with
    these Terms of Service and any other rules of user conduct for our site, or
    is otherwise harmful, objectionable, or inaccurate. We are not responsible
  ...
  <p>
    These other sites and parties are not under our control, and you acknowledge
    that we are not responsible for the accuracy, copyright compliance,
    legality, decency, or any other aspect of the content of such sites, nor are
    we responsible for errors or omissions in any references to other parties or
    their products and services. The inclusion of such a link or reference is
    provided merely as a convenience and does not imply endorsement of, or
    association with, the Website or party by us, or any warranty of any kind,
  ...
  <p>
    ...
    <span class="website_name">kkiokio.com</span> or its Affiliates. All other
    marks are property of their respective owners. Nothing in these Terms of
    Service grants you any right to use any trademark, service mark, logo,
    and/or the name or trade names of
    <span class="website_name">kkiokio.com</span> or its Affiliates.
  </p>
  ...
  <p>
    ...
    <span class="website_name">kkiokio.com</span> spokesperson speaking in
    his/her official capacity. Please refer to the specific editorial policies
    posted on various sections of this Website for further information, which
  ...
  <p>
    ...
    may access in the course of the use of this Website, and therefore, delays
  ...
  <p>
    Although this Website may be accessible worldwide, we make no representation
    that materials on this Website are appropriate or available for use in
    ...
    this Website from other locations do so on their own initiative and are
  ...
  <p>
    ...
    reason, including, without limitation, breach of these Terms of Service. Any
  ...
  <p>
    ...
    right to use the services available on this Website immediately ceases, and
    ...
    further access to such files or this Website. We shall not be liable to you
    or any third party for any claims or damages arising out of any termination
    or suspension or any other actions taken by us in connection with such
  ...
  <p>
    ...
    laws of the <span class="country">us</span> without giving effect to any
  ...
  <p>
    ...
    federal courts of <span class="country">us</span>.
  </p>
</template>
<script>
export default {
