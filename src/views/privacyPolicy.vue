...
<template>
	<article>
				...
				<ul>
					...
					<li>
						<p>
							...
							in this Agreement) refers to Kkiokio.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to Kkiokio, accessible from
							<a
								href="https://portfolio-website-689b4.web.app/"
								rel="external nofollow noopener"
								target="_blank"
								>https://portfolio-website-689b4.web.app/</a
							>
						</p>
					</li>
					<li>
		...
		<section id="contactUs">
			...
			<ul>
				<li>
					<p>By email: hrishikesh.karale@gmail.com</p>
				</li>
				<li>
					<p>
						By visiting this page on our website:
						<a
							href="https://portfolio-website-689b4.web.app/contact"
							rel="external nofollow noopener"
							target="_blank"
							>https://portfolio-website-689b4.web.app/contact</a
						>
					</p>
				</li>
				<li>
					<p>By phone number: 5855207382</p>
				</li>
				<li>
					<p>By mail: 44 Crittenden Way, Apt 2, Rochester, NY 14623, US</p>
				</li>
			</ul>
		</section>
	</article>
