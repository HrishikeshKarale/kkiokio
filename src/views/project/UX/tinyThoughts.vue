    ...
    <section id="Research">
      ...
      <div class="subSection">
        ...
        <p>
          ...
          But in our case we only have 2 primary views – Home &amp; Settings.
          Things like logout and contact support can be grouped under settings
          so I believe those don’t count.
        </p>
        <p>
