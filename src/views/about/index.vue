      ...
      <section id="bio">
        ...
        <div>
          <p>
            ...
            major software projects in the eCommerce and enterprise
            environments.
          </p>
          <p>
            I have a Masters in HCI/Design and a Bachalors in Computer
            Engineering, thus allowing me to take development into consideration
          ...
          <p>
            ...
            projects decisions lead to a massive improvement in the key metrics
            that are relevant to the user experience. In short, I like to think
            like an engineer in addition to being a UX Professional.
          </p>
          <p>
