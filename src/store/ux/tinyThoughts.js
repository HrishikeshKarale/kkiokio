					...
					subsection: [
						...
						},
						{
							...
							content: [
								...
								{
									text: "While uploading an image I thought that I could upload multiple times. After uploading the first one I tapped the image icon again in order to add the second but it ended up replacing the first one.I came to know that you can only upload one image at a time.Basically no affordance was given to me to confirm whether I want to replace the current image or not!"
								},
								{
									altText: "<p> One really awesome feature that I like is the use of <mark>sentiment analysis</mark> while writing the journal.The app can depict your mood while you are typing and comes up with these unique hashtags e.g.#positive - mood. This feature is well implemented and I really like it.Currently you can see your mood over a period of time only in the web application, so I took some cues from there and tried to implement in the redesign. </p > "
								}
							]
						},
						{
									...
									subsection: [
										...
										},
										{
											...
											content: [
												...
												{
													text: "The app also needed a restructured information architecture in order to accommodate the updated features.I went through the Tinythoughts web application in order to see how its navigation differs from the mobile app navigation."
												},
												{
													altText: "<p> < b > TimeLine:</b> Shows all your journal entries </p >"
												},
												{
													altText: "<p> < b > Gallery:</b> A gallery for all the uploaded images(Premium feature) </p >"
												},
												{
													altText: "<p> < b > Mood:</b> Shows mood trends over the selected time period(Premium feature) </p >"
												},
												{
													text: "These had to be included in the app as well in order to make a consistent experience across all platforms."
												},
												{
													img: {
												...
												{
													text: "I have not tried the premium features yet but I had some ideas of how these could be implemented within the mobile app.So after analyzing and ideating, I went on to make the final prototypes."
												}
											]
										}
									]
							...
							content: [
								{
									section: {
										...
										content: [
											{
												text: "I usually begin implementing by ideas on pen and paper rather than directly going on to the screen.I feel like paper wireframes is the	cheapest and least time consuming way to experiment with multiple ideas.Here is some of the clutter that I generated."
											},
											{
												img: {
												...
												subsection: [
													{
														...
														content: [
															{
																text: "Pixel pushing time! I wanted to keep the primary color as it is because it’s currently being used on both mobile as the web application, hence adhering to the brand guidelines."
															},
															{
																img: {
						...
						},
						{
							...
							content: [
								{
									text: "I shared a working prototype of the redesign with my fellow UX Professionals.They appreciated the fact that I took time to clean up the current design and made it more usable.I came to know that this app was started as a side project by the original Jess(Original reator) and right now is used by many people as their go to daily journaling app.While Jess is looking to bring new updates in the future I will also be revisiting the app in the near future to look into the functionality that could be added to this platform."
								},
								{
									text: "Who knows these redesigned bits might end up getting implemented in the a version ofmy own app! On the other hand I gained a better understanding about Google’s Material Guidelines and how to use it in order to design more consistent interfaces."
								}
							]
						}
					]
