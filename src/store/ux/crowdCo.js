	...
	section: [
		{
			...
			content: [
				{
					altText: "<p> < strong > Overview:</strong> The project was a part of VUE + Electron UpLabs Challenge.The end goal of the experience was to develop a functioning iOS and Android app using the VUE + Electron framework. < br /> Since there was no specific theme defined for the app within the challenge, I went on to build a reward based crowdfunding application. The main aim here was to spread awareness of this product concept among general audience. </p >"
				},
				{
					altText: "<p> < strong > Duration:</strong> 3 + Weeks </p >"
				},
				{
					altText: "<p> < strong > Role:</strong> Product design & amp; App development </p >"
				},
				{
					altText: "<p> < strong > Skills:</strong> User research, User experience design, User interface design, App development using VUE + Electron framework </p >"
				},
				{
					altText: "<p> < strong > Solution:</strong> A functional iOS and Android app that can demonstrate the crowdfunding concept to general audience.The app development is in progress. </p >"
				}
			]
		}, //sections
		{
					...
					subsection: [
						{
							...
							content: [
								...
								{
									text: "Probably the biggest difference between the two platforms is their approach to money and when you get it.Kickstarter releases funds only after the campaign reaches its funding goal(fixed funding), Indiegogo provides you with an opportunity to choose between receiving funding as it comes in(flexible funding) or waiting to see if you hit your target(fixed funding)."
								}
							]
						}, //subsection
						{
							...
							content: [
								{
									text: "After doing the Competitor analysis, I needed more research data on these current market players.So I went on Play Store & amp; App Store to find out what the daily users of these applications think? After all they are the people who are using these apps almost everyday and must be knowing what exactly is missing and how to make the current platform more usable for them."
								},
								{
									text: "Unfortunately, I could not do research on Indiegogo app as it was not available in my country so I went on Kickstarter to see what could be found."
								},
								{
									img: {
		...
		//sections
		{
			...
			content: [
				...
				{
					text: "Based on the competitor analysis &amp; the app reviews that I got from play store, I went on to create proto personas as it incorporates the needs, goals, and observed behavior patterns of my target audience."
				},
				{
					subsection: [
						{
							...
							content: [
								{
									text: "I decided to create two investor personas. Each persona varied in crowdfunding investing experience and as a result they required very different pieces of information in order to make their final decision."
								},
								{
									img: {
								...
								{
									text: "The first persona was for an inexperienced investor named Greg who is new to reward based crowdfunding and wants someone to help him on how to invest."
								},
								{
									img: {
								...
								{
									text: "The second persona was for a professional investor named Jennie. She has been working as an Angel Investor for the past 10 years and likes to help startups who are looking for financial support in order to scale their products."
								}
							]
						}, //subsection
						{
							...
							content: [
								{
									text: "In order to relate to the life of my personas, I ended up writing user stories as they would allow me to articulate the user’s perspective and generate ideas that fit into the user’s life."
								},
								{
									img: {
		...
		}, //sections
		{
			...
			content: [
				{
					text: "After defining the needs of my users and documenting what exactly was needed to build this product, the next step was to pick up my tools.I enjoy this phase because I get to see all my research data getting converted into something that people would be able to visualize and then provide feedback of what could be done better."
				},
				{
					subsection: [
						{
		...
		},
		{
			...
			content: [
				...
				{
					altText: "<p> While developing the app it came to my notice that I unknowingly skipped one of the most basic design concept mentioned in <a href = 'https://developer.apple.com/design/tips/' target = '_blank' rel = 'noopener noreferrer' >iOS HIG</a >. </p >"
				},
				{
					img: {
				...
				{
					text: "Apple expects you to keep the text size to be at least 11 pts in your apps so that it is easily readable by everyone.I discovered that some of the text in my design was less than the default size so I fixed that during my development."
				}
			]
		}, //sections
		{
			...
			content: [
				{
					text: "To be honest the app development is still under progress but I am glad I took this challenge as it taught me how to manage my time more than anything else."
				},
				{
					img: {
