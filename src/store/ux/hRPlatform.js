	...
	section: [
		{
			...
			content: [
				{
					altText: "<p> < strong > Overview:</strong> <a href='https://www.peoplematters.in/' target='_blank' rel='noopener'> People Matters </a> is an HR media platform founded in 2009 and they aim to foster ideas between HR - related professionals.People Matters prints a magazine, does online publishing, conducts research and creates events focused on human resources.The goal of this project was to develop a program learning platform MVP for them a.k.a < strong > People Matters COHORT. </strong> Their team would be collaborating with various industry leaders in the future to offer specific programs/ courses for people within their established network. </p >"
				},
				{
					altText: "<p> < strong > Objective:</strong> To Create a Program learning platform for the People Matters. </p >"
				},
				{
					altText: "<p> < strong > Skills:</strong> User experience design, User interface design, Wireframing, Information Architecture </p >"
				},
				{
					altText: "<p> < strong > Contribution:</strong> I worked with another designer on this project.I was involved in creating user flows, defining information architecture and designing the whole user experience of the product. </p >"
				},
				{
		...
		}, //sections
		{
			...
			content: [
				{
					text: "We began with preliminary calls with the client in order to understand their expectations with this platform and also to be on the same page as to what will be the scope of this project.Doing these initial interviews with the client gave us a bunch of Qualitative data to work on and analyze."
				},
				{
					text: "Upon further discussions, we came to know that one of their competitors is an online collaborative learning learning platform by the name of NovoEd.We decided to hop on their platform and went through their whole experience along with analyzing what they have on offer."
				},
				{
					subsection: [
						{
							...
							content: [
								{
									altText: "<p> After browsing through NovoEd’s platform, we found a bunch of stuff that they had on offer.Their < strong > value proposition</strong> was to “Deliver an engaging learning environment for maximum impact”. Here is list of other pointers that we saw on the platform and which acted as an inspiration for us while designing our own experience for the COHORT –"
								},
								{
									img: {
		...
		}, //sections
		{
			...
			content: [
				{
					text: "After doing the competitor analysis, it was time to ideate about the features of the platform and how would the whole experience feel like. With multiple paper wireframes, brainstorming sessions and 2923 cups of coffee, we came up with the first iteration of the Dashboard."
				},
				{
					subsection: [
						{
						...
						}, //subsection
						{
							...
							content: [
								...
								{
									text: "We also updated the My Network section on the right by giving the users more information in order to drive more engagement.Showing the most active members on the platform encourages others to participate more so that they can also become a part of that elite list of people who spend more time on the platform learning new stuff."
								}
							]
						}, //subsection
						{
							...
							content: [
								...
								{
									text: "As discussed with the client, a segment can be a mix of audio, text &amp; video based learning.Hence we decided to put a label for time that denotes how much time will it take to complete that sub- lesson. This gives the user an overview of how much time they will be spending on learning new stuff."
								},
								{
									img: {
						...
						}, //subsection
						{
							...
							content: [
								...
								{
									text: "Another addition we did was the quick menu to access all the sub- section items at one place.It saved the hassle for the user to go back to the program screen again and again.They could navigate between all the sub- lessons at one place!"
								}
							]
						}, //subsection
						{
							...
							content: [
								{
									altText: "<p> A submissions gallery is something that is <strong>specific to a program</strong>.It is a place where one can explore submissions from different members who are currently enrolled in the same program.The idea behind designing a submissions gallery was to allow someone to have a look at the submissions / assignments submitted by their peers before submitting their own. </p >"
								},
								{
									img: {
								...
								{
									text: "One way to make it more engaging was that we allowed people to leave comments and likes on other member’s submission.This would encourage the exchange of ideas and people would get to know the thought process gone behind a submission."
								}
							]
						}, //subsection
						{
							...
							content: [
								{
									text: "The concept behind designing a discussion wall was to give people a place where they could interact with each other and network.We came to know that the people who would be having access to this COHORT will be the ones looking to expand their network and hence it made absolute sense to introduce a place where they could interact and share their ideas.So here are the two things that we kept in mind while creating the experience for a discussion –"
								},
								{
									img: {
