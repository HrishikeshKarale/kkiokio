	...
	section: [
		...
		}, //sections
		{
			...
			content: [
				...
				{
					text: "Here the users can see both accounts(Naira and Dollar) and their respective amounts.The plus icon on each account lets the users know they can add(topup) more money to the respective accounts."
				},
				{
					text: "The next set of screens are the Top up, Pay bills and apply for loan screens"
				},
				{
					img: {
				...
				{
					text: "They are a number of bills (utility, subscribtions etc.) that could be directly paid using a mobile application, so I put them on a seperate screen called Bill Pay.I broke them down into their different categories to make it easier for the users to pay bills rather than scrolling through ten's of options."
				},
				{
					img: {
		...
		}, //sections
		{
			...
			content: [
				{
					text: "I would not say the user experience fits a description of the “fun” mobile application Rupay has tried to position itself as.Some of its aesthetics are obviously echoing its competitors, but it is certainly more engaging than your run- of - the - mill fintech apps."
				},
				{
					text: "It will be interesting to see how Rupay evolves, especially with major institutions now integrating Rupay’s fundamental functionality into their platforms.To combat the tech behemoth entering their space, Rupay may have to embrace their social media roots further to differentiate, or keep improving on their user experience."
				}
			]
		} //section
	]
